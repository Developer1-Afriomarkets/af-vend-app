...
class ConditionsCard extends StatelessWidget {
  const ConditionsCard(this.discount, {this.promotionCrudBloc, super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              IconButton(
                  ...
                  onPressed: () async {
                    ...
                    //   PromotionCrudBloc?.add(PromotionCrudEvent.addCondition(
                    //       discount.id,
                    //       CreateConditionReq(
          ...
          //                 if (context.mounted) {
          //                   PromotionCrudBloc?.add(
          //                       PromotionCrudEvent.removeCondition(
          ...
          //                   PromotionCrudBloc?.add(
          //                       PromotionCrudEvent.addItemsToCondition(
          //                           discount.id, condition.id!, addedItems));
          //                 }
          //                 if (deletedItems.isNotEmpty) {
          //                   PromotionCrudBloc?.add(
          //                       PromotionCrudEvent.removeItemsFromCondition(
